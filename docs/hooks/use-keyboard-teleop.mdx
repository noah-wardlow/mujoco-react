...
function TeleopControls() {
  useKeyboardTeleop({
    bindings: {
      "w": { actuator: RobotActuators.franka.actuator1, delta: 0.1 },
      "s": { actuator: RobotActuators.franka.actuator1, delta: -0.1 },
      "a": { actuator: RobotActuators.franka.actuator2, delta: 0.1 },
      "d": { actuator: RobotActuators.franka.actuator2, delta: -0.1 },
      "space": { actuator: RobotActuators.franka.gripper, toggle: [0, 0.04] },
    },
    enabled: true,
  });
...
```tsx
import { RobotActuators } from "mujoco-react";

"space": { actuator: RobotActuators.franka.gripper, toggle: [0, 0.04] }
// Press space: ctrl[RobotActuators.franka.gripper] = 0
// Press again: ctrl[RobotActuators.franka.gripper] = 0.04
```
