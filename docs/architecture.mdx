---
title: "Architecture"
description: "Provider pattern, physics loop, and rendering pipeline"
icon: "sitemap"
---
...
- Manages IK solver state and animation
...
│  4. mj_step × substeps (loop until sim catches up)  │
│  5. Run useAfterPhysicsStep callbacks                │
│  6. Fire onStep callback                             │
└─────────────────────────────────────────────────────┘
          │
          ▼
┌─────────────────────────────────────────────────────┐
...
### 1. `onReady` callback (outside R3F)
